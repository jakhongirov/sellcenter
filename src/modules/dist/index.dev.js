...
var sliders = require('./slider/slider'); //Cars files


var carBrand = require('./carBrand/carBrand');

var carOthers = require('./carOtherDetails/carOtherDetails');

var carExtras = require('./carExtraDetails/carExtraDetails');
...
.get('/users/list', users.GET_USERS_LIST).get('/users', users.GET).post('/user/register', users.REGISTER_USER).post('/user/login', users.LOGIN).put('/user/edit/mail', users.EDIT_USER_EMAIL).put('/user/edit/name', users.EDIT_USER_NAME).put('/user/edit/address', users.EDIT_USER_ADDRESS).put('/user/edit/phone', users.EDIT_USER_PHONE_NUMBER).put('/user/edit/balance', users.EDIT_USER_BALANCE).put('/user/edit/photo', FileUpload.single("photo"), users.EDIT_PROFILE_IMAGE)["delete"]('/user/delete', users.DELETE_USER) // User ads
...
.get('/companies/admin/list', companies.GET_ADMIN).get('/company/:id', companies.GET_USER_COMPANY).post('/company/add', companies.POST_COMPANY).put('/company/edit', companies.PUT_COMPANY)["delete"]('/company/delete', companies.DELETE_COMPANY) // ADS
...
.get('/slider/admin/list', sliders.GET_ADMIN).get('/slider/list', sliders.GET).post('/slider/add', FileUpload.single("photo"), sliders.POST).put('/slider/update', FileUpload.single("photo"), sliders.PUT).put('/slider/update/status', sliders.PUT_STATUS)["delete"]('/slider/delete', sliders.DELETE) // Car makrs 
...
.get('/car/model', carBrand.GET_MODEL).post('/car/add/model', carBrand.POST_MODEL).put('/car/update/model', carBrand.PUT_MODEL)["delete"]('/car/delete/model', carBrand.DELETE_MODEL) // Car others
.get('/car/others', carOthers.GET).post('/car/add/other', carOthers.POST).put('/car/update/other', carOthers.PUT)["delete"]('/car/delete/other', carOthers.DELETE) // Car extras
.get('/car/extras', carExtras.GET).post('/car/add/extra', carExtras.POST).put('/car/update/extra', carExtras.PUT)["delete"]('/car/delete/extra', carExtras.DELETE) // Cars
.get('/cars/admin/list', cars.GET_ADMIN).get('/cars/list', cars.GET_CARS).get('/cars/count', cars.GET_CARS_COUNT).get('/car/:id', cars.GET_CAR_ID).post('/car/add', FileUpload.array("photos"), cars.POST_CAR).put('/car/update', FileUpload.array("photos"), cars.UPDATE_CAR)["delete"]('/car/delete', cars.DELETE_CAR) // Motorcycle marks
