...
var sliders = require('./slider/slider'); // News file


var news = require('./news/news'); // PRICE LIST file


var priceList = require('./priceList/priceList'); //Cars files
...
.get('/companies/admin/list', companies.GET_ADMIN).get('/company/:id', companies.GET_USER_COMPANY).post('/company/add', companies.POST_COMPANY).put('/company/edit', companies.PUT_COMPANY).put('/company/edit/photo', FileUpload.single("photo"), companies.EDIT_PROFILE_IMAGE)["delete"]('/company/delete/:id', companies.DELETE_COMPANY) // ADS
...
.get('/news/admin/list', news.GET_ADMIN).get('/news/list', news.GET).get('/news/:id', news.GET_ID).post('/news/add', FileUpload.single("photo"), news.POST).put('/news/update', FileUpload.single("photo"), news.PUT).put('/news/update/status', news.PUT_STATUS)["delete"]('/news/delete', news.DELETE) // PRICE LIST
.get('/price/admin/list', priceList.GET_ADMIN).get('/price/list', priceList.GET).post('/pay', priceList.PAYMENT).post('/price/list/add', priceList.ADD_PRICE).put('/price/list/update', priceList.UPDATE_PRICE).put('/price/list/update/status', priceList.UPDATE_PRICE_STATUS)["delete"]('/price/list/delete', priceList.DELETE_PRICE) // Car makrs 
...
.get('/motorcycle/model', motorcycleBrand.GET_MODEL).post('/motorcycle/add/model', motorcycleBrand.POST_MODEL).put('/motorcycle/update/model', motorcycleBrand.PUT_MODEL)["delete"]('/motorcycle/delete/model', motorcycleBrand.DELETE_MODEL) // Motorcycle
.get('/motorcycles/admin/list', motorcycle.GET_ADMIN).post('/motorcycles/list', motorcycle.GET_MOTORCYCLE).post('/motorcycles/count', motorcycle.GET_MOTORCYCLE_COUNT).get('/motorcycles/:id', motorcycle.GET_MOTORCYCLE_ID).post('/motorcycles/add', FileUpload.array("photos"), motorcycle.POST_MOTORCYCLE).put('/motorcycles/update', FileUpload.array("photos"), motorcycle.PUT_MOTORCYCLE).put('/motorcycles/update/status', motorcycle.UPDATE_STATUS)["delete"]('/motorcycles/delete', motorcycle.DELETE_MOTORCYCLE) // Motor home marks
...
.get('/motorhome/model', motorhomeBrand.GET_MODEL).post('/motorhome/add/model', motorhomeBrand.POST_MODEL).put('/motorhome/update/model', motorhomeBrand.PUT_MODEL)["delete"]('/motorhome/delete/model', motorhomeBrand.DELETE_MODEL) // Motor homes
.get('/motorhomes/admin/list', motorhomes.GET_MOTOR_HOME).post('/motorhomes/list', motorhomes.GET_MOTOR_HOME).post('/motorhomes/count', motorhomes.GET_COUNT_MOTOR_HOME).get('/motorhomes/:id', motorhomes.GET_MOTORHOME_ID).post('/motorhomes/add', FileUpload.array("photos"), motorhomes.POST_MOTOR_HOME).put('/motorhomes/update', FileUpload.array("photos"), motorhomes.PUT_MOTOR_HOME).put('/motorhomes/update/status', motorhomes.UPDATE_STATUS)["delete"]('/motorhomes/delete', motorhomes.DELETE_MOTOR_HOME) // Truck makrs 
...
.get('/truck/model', truckBrand.GET_MODEL).post('/truck/add/model', truckBrand.POST_MODEL).put('/truck/update/model', truckBrand.PUT_MODEL)["delete"]('/truck/delete/model', truckBrand.DELETE_MODEL) // Trcuks
.get('/trucks/admin/list', trucks.GET_ADMIN).post('/trucks/list', trucks.GET_TRUCK_LIST).post('/trucks/count', trucks.GET_TRUCK_COUNT).get('/trucks/:id', trucks.GET_TRUCK_ID).post('/trucks/add', FileUpload.array("photos"), trucks.POST_TRUCK).put('/trucks/update', FileUpload.array("photos"), trucks.PUT_TRUCK).put('/trucks/update/status', trucks.UPDATE_STATUS)["delete"]('/trucks/delete', trucks.DELETE_TRUCK) // Trailer makrs 
...
.get('/trailer/model', trailerBrand.GET_MODEL).post('/trailer/add/model', trailerBrand.POST_MODEL).put('/trailer/update/model', trailerBrand.PUT_MODEL)["delete"]('/trailer/delete/model', trailerBrand.DELETE_MODEL) // Trailers
.get('/trailers/admin/list', trailers.GET_ADMIN).post('/trailers/list', trailers.GET_TRAILER_LIST).post('/trailers/count', trailers.GET_TRAILER_COUNT).get('/trailers/:id', trailers.GET_TRAILER_BY_ID).post('/trailers/add', FileUpload.array("photos"), trailers.POST_TRAILER).put('/trailers/update', FileUpload.array("photos"), trailers.PUT_TRAILER).put('/trailers/update/status', trailers.UPDATE_STATUS)["delete"]('/trailers/delete', trailers.DELETE_TRAILER) // Van makrs 
...
.get('/van/model', vanBrand.GET_MODEL).post('/van/add/model', vanBrand.POST_MODEL).put('/van/update/model', vanBrand.PUT_MODEL)["delete"]('/van/delete/model', vanBrand.DELETE_MODEL) // Vans
.get('/vans/admin/list', vans.GET_ADMIN).post('/vans/list', vans.GET_VAN_LIST).post('/vans/count', vans.GET_VAN_COUNT).get('/vans/:id', vans.GET_VAN_ID).post('/vans/add', FileUpload.array("photos"), vans.POST_VAN).put('/vans/update', FileUpload.array("photos"), vans.PUT_VAN).put('/vans/update/status', vans.UPDATE_STATUS)["delete"]('/vans/delete', vans.DELETE_VAN) // Semi truck makrs 
...
.get('/semitruck/model', semitruckBrand.GET_MODEL).post('/semitruck/add/model', semitruckBrand.POST_MODEL).put('/semitruck/update/model', semitruckBrand.PUT_MODEL)["delete"]('/semitruck/delete/model', semitruckBrand.DELETE_MODEL) // Semi truck
.get('/semitrucks/admin/list', semitruck.GET_SEMI_TRUCK_LIST).post('/semitrucks/list', semitruck.GET_SEMI_TRUCK_LIST).post('/semitrucks/count', semitruck.GET_SEMI_TRUCK_COUNT).get('/semitruck/:id', semitruck.GET_SEMI_TRUCK_ID).post('/semitruck/add', FileUpload.array("photos"), semitruck.POST_SEMI_TRUCK).put('/semitruck/update', FileUpload.array("photos"), semitruck.PUT_SEMI_TRUCK)["delete"]('/semitruck/delete', semitruck.DELETE_SEMI_TRUCK) // Semi trailer makrs 
...
.get('/semitrailer/model', semitrailerBrand.GET_MODEL).post('/semitrailer/add/model', semitrailerBrand.POST_MODEL).put('/semitrailer/update/model', semitrailerBrand.PUT_MODEL)["delete"]('/semitrailer/delete/model', semitrailerBrand.DELETE_MODEL) // Semi trailer
.get('/semitrailers/admin/list', semitrailers.GET_ADMIN).post('/semitrailers/list', semitrailers.GET_TRAILER_LIST).post('/semitrailers/count', semitrailers.GET_TRAILER_COUNT).get('/semitrailer/:id', semitrailers.GET_TRAILER_BY_ID).post('/semitrailer/add', FileUpload.array("photos"), semitrailers.POST_TRAILER).put('/semitrailer/update', FileUpload.array("photos"), semitrailers.PUT_TRAILER).put('/semitrailer/update/status', semitrailers.UPDATE_STATUS)["delete"]('/semitrailer/delete', semitrailers.DELETE_TRAILER) // Coache makrs 
...
.get('/coache/model', coacheBrand.GET_MODEL).post('/coache/add/model', coacheBrand.POST_MODEL).put('/coache/update/model', coacheBrand.PUT_MODEL)["delete"]('/coache/delete/model', coacheBrand.DELETE_MODEL) // Coache
.get('/coaches/admin/list', coaches.GET_ADMIN).post('/coaches/list', coaches.GET_COACHES_LIST).post('/coaches/count', coaches.GET_COACHES_COUNT).get('/coaches/:id', coaches.GET_COACHE_ID).post('/coaches/add', FileUpload.array("photos"), coaches.POST_COACHE).put('/coaches/update', FileUpload.array("photos"), coaches.PUT_COACHE).put('/coaches/update/status', coaches.UPDATE_STATUS)["delete"]('/coaches/delete', coaches.DELETE_COACHE) // Agricultural makrs 
...
.get('/agricultural/model', agriculturalBrand.GET_MODEL).post('/agricultural/add/model', agriculturalBrand.POST_MODEL).put('/agricultural/update/model', agriculturalBrand.PUT_MODEL)["delete"]('/agricultural/delete/model', agriculturalBrand.DELETE_MODEL) // Agricultural
.get('/agriculturals/admin/list', agriculturals.GET_ADMIN).post('/agriculturals/list', agriculturals.GET_VEHICLE_LIST).post('/agriculturals/count', agriculturals.GET_VEHICLE_COUNT).get('/agriculturals/:id', agriculturals.GET_VEHICLE_ID).post('/agriculturals/add', FileUpload.array("photos"), agriculturals.POST_VEHICLE).put('/agriculturals/update', FileUpload.array("photos"), agriculturals.PUT_VEHICLE).put('/agriculturals/update/status', agriculturals.UPDATE_STATUS)["delete"]('/agriculturals/delete', agriculturals.DELETE_VEHICLE) // Construction makrs 
...
.get('/construction/model', constructionBrand.GET_MODEL).post('/construction/add/model', constructionBrand.POST_MODEL).put('/construction/update/model', constructionBrand.PUT_MODEL)["delete"]('/construction/delete/model', constructionBrand.DELETE_MODEL) // Construction
.get('/constructions/admin/list', constructions.GET_ADMIN).post('/constructions/list', constructions.GET_CONSTRUCTION_LIST).post('/constructions/count', constructions.GET_CONSTRUCTION_COUNT).get('/constructions/:id', constructions.GET_CONSTRUCTION_ID).post('/constructions/add', FileUpload.array("photos"), constructions.POST_CONSTRUCTION).put('/constructions/update', FileUpload.array("photos"), constructions.PUT_CONSTRUCTION).put('/constructions/update/status', constructions.UPDATE_STATUS)["delete"]('/constructions/delete', constructions.DELETE_CONSTRUCTION) // Forklift makrs 
...
.get('/forklift/model', forkliftBrand.GET_MODEL).post('/forklift/add/model', forkliftBrand.POST_MODEL).put('/forklift/update/model', forkliftBrand.PUT_MODEL)["delete"]('/forklift/delete/model', forkliftBrand.DELETE_MODEL) // Forklift
.get('/forklifts/admin/list', forklifts.GET_ADMIN).post('/forklifts/list', forklifts.GET_FORKLIFT_LIST).post('/forklifts/count', forklifts.GET_FORKLIFT_COUNT).get('/forklifts/:id', forklifts.GET_FORKLIFT_ID).post('/forklifts/add', FileUpload.array("photos"), forklifts.POST_FORKLIFT).put('/forklifts/update', FileUpload.array("photos"), forklifts.PUT_FORKLIFT).put('/forklifts/update/status', forklifts.UPDATE_STATUS)["delete"]('/forklifts/delete', forklifts.DELETE_FORKLIFT);
